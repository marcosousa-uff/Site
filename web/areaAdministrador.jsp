...
<html>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<ul class="navbar-nav">
			 <li class="nav-item active"><a class="nav-link" href=<%=link%>>Area do Administrador</a></li>
                         <li class="nav-item"><a class="nav-link" href="cadastrarUsuario.jsp">Cadastrar Usuarios</a></li>
                         <li class="nav-item"><a class="nav-link" href="ListarProdutos">Estoque</a></li>
                         <li class="nav-item"><a class="nav-link" href="mudaDisponibilidade.jsp">Disponibilidade</a></li>
